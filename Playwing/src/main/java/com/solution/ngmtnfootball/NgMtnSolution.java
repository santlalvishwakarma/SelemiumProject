	...
	public String getProcessSolution(String msisdn, String ip, String cmpUrl) {
		...
		try {
			...
			if (firstHtmlPage != null) {
				...
				HtmlDivision htmlDivision = (HtmlDivision) firstHtmlPage.getElementById("SubscribeBTN_ArtistPage_byWeb_undefined");
				HtmlButton button= (HtmlButton) htmlDivision.getFirstChild();
