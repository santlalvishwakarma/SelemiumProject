...
public class KenyaSolution {
  ...
  public String getProcessSolution(String msisdn, String ip, String cmpUrl) {
    ...
    try {
      ...
      HtmlAnchor input = (HtmlAnchor)domDocType.getElementById("lnkSubscribe");
      if (input != null) {
  ...
  public static void main(String[] args) {
    ...
    try {
      KenyaSolution kenyaSolution = new KenyaSolution();
      kenyaSolution.getProcessSolution("2348124882749", "105.112.0.12", "https://infinite-mobility.g2afse.com/click?pid=236&offer_id=28684");
    } catch (Exception e) {
